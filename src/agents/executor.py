...
from mcp_core.schemas import MCPServerConfig, MCPToolResult
from mcp_core.exceptions import MCPException
...
# Which MCP server(s) handle which supervisor intent.
# Only "gmail" is wired up for now — add slack/github back here as they come online.
INTENT_SERVER_MAP: dict[str, list[str]] = {
    "send_email": ["gmail"],
    "reply_email": ["gmail"],
    "search_email": ["gmail"],
